...
class OsuReplay{
	constructor(){
		...
		this.beatmapMD5 = null
		this.playerName = null
		this.replayMD5 = null
		this.number_300s = null
		this.number_100s = null
		this.number_50s = null
		this.gekis = null
		this.katus = null
		this.misses = null
		this.score = null
		this.max_combo = null
		this.perfect_combo = null
		this.mods = null
		this.life_bar = null
		this.timestamp = null
		this.replay_length = null
...
function readSync(buff){
	return _read(buff)
}
function read(buff,cb){
	return _read(buff,cb)
}
...
module.exports.Replay = OsuReplay
